...
for n in range(number_of_pages):
    ...
    for linha in listaLinhas:
        if 'SEGURIDADE SOCIAL - FUNDO FINANCEIRO' in linha and 'INSTITUTO:' not in linha:
...
with open('PLANILHA_FOLHA_NORMAL_FINANCEIRO_OUTUBRO_2022.csv', mode='w') as PLANILHA_FOLHA_NORMAL_FINANCEIRO_OUTUBRO_2022:
    teste_writer = csv.writer(PLANILHA_FOLHA_NORMAL_FINANCEIRO_OUTUBRO_2022, delimiter=';', quotechar='|',quoting=csv.QUOTE_MINIMAL)
...
# ------------------------------------------------------------------------------------------------------------------------------------------
    ...
    teste_writer.writerow(['PATRONAL FUNDO FINANCEIRO',listaux2[1],listaux2[2],listaux2[9],listaux2[10],listaux2[3]])